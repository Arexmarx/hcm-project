...
const coreValues = [
  {
    ...
    description:
      "Phẩm chất quan trọng nhất. Suốt đời phấn đấu hy sinh vì độc lập,\ntự do của Tổ quốc.",
    quote:
    ...
    icon: (
      ...
      >
        ...
        />
        <polygon
          points="100,40 130,80 175,80 145,115 160,155 100,120 40,155 55,115 25,80 70,80"
          fill="currentColor"
        />
      </svg>
    ),
  },
  {
    ...
    description:
      "Con người phát triển toàn diện: Đức, Trí, Thể, Mỹ. Có tinh thần \nyêu nước, tự cường dân tộc, lối sống lành mạnh.",
  ...
  },
  {
    ...
    description:
      "Xây dựng nền văn hóa Việt Nam tiên tiến, đậm đà bản sắc dân tộc; thống nhất mà đa dạng.",
  ...
  },
  {
    ...
    description:
      "Xây dựng môi trường văn hóa lành mạnh, nếp sống văn minh, bảo vệ môi trường cho thế hệ tương lai.",
    quote:
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-7xl font-display font-black mb-6 animate-text-reveal leading-tight">
            <span className="text-gradient-gold block leading-tight">
              Bốn Trụ Cột
            </span>
            <span className="text-white/90 block italic mt-2">
              Văn Hóa & Con Người
            </span>
          </h2>
          <div className="section-divider my-8"></div>
          <p className="text-white/75 text-lg md:text-xl max-w-3xl mx-auto font-body">
            Theo tư tưởng Hồ Chí Minh, xây dựng văn hóa và con người Việt Nam
            dựa trên bốn giá trị cốt lõi
          </p>
        </div>

        <div
          className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-all duration-1000 ${isVisible ? "animate-slide-up" : "opacity-0"}`}
        >
          {coreValues.map((value, index) => (
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <p className="text-white/75 mb-4 leading-relaxed flex-grow whitespace-pre-line">
                  {value.description}
                </p>
